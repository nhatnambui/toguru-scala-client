...
class PlayClientInfoSupportSpec extends FeatureSpec {
  ...
  val requestHeaderWithFeatureToggleUnusualCase = FakeRequest.apply("GET", "http://priceestimation.autoscout24.de?featureBee=feature-FORCED-by-query-param%3Dtrue", fakeHeaders, "body")
  val requestHeaderWithTwoFeaturesInQueryString = FakeRequest.apply("GET",
    "http://priceestimation.autoscout24.de?featureBee=feature1-forced-by-query-param%3Dtrue%7Cfeature2-forced-by-query-param%3Dfalse", fakeHeaders, "body")
